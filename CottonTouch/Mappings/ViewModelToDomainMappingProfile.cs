...
namespace CottonTouch.Mappings
{
    public class ViewModelToDomainMappingProfile : Profile
    {
        ...
        protected override void Configure()
        {
            ...
            // ServiceRequestViewModel  --> ServiceRequest
            Mapper.CreateMap<ServiceRequestViewModel, ServiceRequest>()
            ...
            // ItemServiceRequestViewModel  --> ItemServiceRequest
            Mapper.CreateMap<ItemServiceRequestViewModel, ItemServiceRequest>()
            ...
            // HotelItemPriceViewModel  --> HotelItemPrice
            Mapper.CreateMap<HotelItemPriceViewModel, HotelItemPrice>()
